...
# When in export mode the little dots are unaligned, so fix that. 
if(PDF_EXPORT){
  cat("View this CV online at _maxlarter.github.io/cv_")
}
```

Contact {#contact}
--------------------------------------------------------------------------------
- <i class="fa fa-envelope"></i> maximilian.larter_AT_gmail.com
- <i class="fa fa-twitter"></i> [twitter](https://x.com/maxlarter) / [Bluesky](https://bsky.app/profile/maxlarter.bsky.social)
...
- gas exchange, sapflow
- wood anatomy, microscopy

**Molecular biology, phylogenetics**

- DNA/RNA extractions, qPCR
- NGS library prep

**Academic service**

- Peer reviews: (>20)
[New Phytol, Tree Phys, PCE, Am J Bot, BMC Evol. Biol.](https://www.webofscience.com/wos/author/record/I-5800-2019)
- Postdoc & short contract rep. CU Biogeco 2021-2022
...
My primary research interest is understanding how plants respond and adapt to their environment, in particular in the current climate crisis. I study functional traits to gain insights into key physiological functions, and to predict the impacts of climate change on the performance, survival, and future distributions of wild and cultivated species.
...
h_index <- predict_h_index(MaxLarter)[1,2]
cites_total <- sum(get_citation_history(MaxLarter)[,2])
cit_stats <- paste0(cites_total," citations, h-index ",h_index)
cat(noquote(unlist(cit_stats)))
```
...
```{r, include=FALSE}
# run Rmd file to print to pdf!
# copy html CV to github pages repo and rename "cv.html"
